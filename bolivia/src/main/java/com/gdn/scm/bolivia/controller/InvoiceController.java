...
//    public void createUploadHistory(@RequestBody InvoiceRequest request) {
...
//    public List<Invoice> getAllUploadHistory() {
...
//    public List<Invoice> filterByMonth(@PathVariable("month") String month) {
