            ...
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                    <router-link to="/" tag="li" exact>
                        <a class="logo"><i class="menu-icon ti-desktop"></i><span class="mm-text">Dashboard</span></a>
                    </router-link>
                    <router-link tag="li" to="/invoicepage" exact>
                        <a class="logo"><i class="menu-icon ti-layout-list-large-image"></i><span class="mm-text">Invoice</span></a>
                    </router-link>
                    <router-link tag="li" to="/awb" exact>
                        <a class="logo"><i class="menu-icon ti-layout-list-large-image"></i><span class="mm-text">AWB</span></a>
                    </router-link>
